...
public class CafeTest {
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            if(cmd==Command.QUIT){System.out.println("Bye!"); break;}
            if(cmd==Command.INVALID){System.out.println("Invalid Operation!"); continue;}
            switch (cmd){
                case ADD: {
    ...
    private static void findBeverage(Cafe cs) {
    ...
    private static Command getCommand(Scanner scanner) {
        ...
        try{command = Command.valueOf(commandStr);}
